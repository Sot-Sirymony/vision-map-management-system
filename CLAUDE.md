...
## Claude Code Role
You are Claude Code acting as a senior full-stack engineer, technical architect, and implementation assistant.
...
1. Read this `CLAUDE.md` before making decisions.
